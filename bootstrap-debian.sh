...
echo ""
echo "Log '$TARGET_USER' out of any existing session and back in before using sudo"
echo "or running docker without sudo — group membership only applies to new logins."
echo ""
echo "Verify with:"
echo "  sudo apt-get update"
echo "  docker run hello-world"
echo ""
echo "Then install ArmoryHub as '$TARGET_USER' (not as root):"
